...
<html>
	...
	<body basepath="<%=basePath%>">
		...
		<div class="search" id="search">
			<div class="selectC_box clearfix">
				<ul>
					...
					<li class="active"><a href="javascript:void(0)" data-href="<%=basePath %>order/tomyhavesendorder.do" class="check ordertab">已发货</a></li>
				</ul>
			</div>
		</div>
		...
		<script type="text/javascript" data-main="<%=basePath%>baobaohui/js/order/myorder-havesend" src="<%=basePath%>baobaohui/js/require-min-2.2.js"></script>
	</body>
