...
<html>
	...
	<body basepath="<%=basePath%>">
		...
		<div class="search" id="search">
			<div class="selectC_box clearfix">
				...
				<ul>
					...
					<li><a class="ordertab" data-href="<%=basePath %>order/towaitsendsale.do">待发货</a></li>
					<li class="all active"><a data-href="<%=basePath %>order/tohavesendsale.do" class="check ordertab">已发货</a></li>
				</ul>
			</div>
		</div>
			...
			<ul id="orderlists">
				...
				<li class="articleItem">
					...
					<div class="articlefooter clearfix"><span>应收:&nbsp;<span class="colr">¥200</span></span>
						<a class="acc_upload pay-btn">还 款</a>
					</div>
				</li> -->
		...
		<script type="text/javascript" data-main="<%=basePath%>baobaohui/js/sale/mysale-havesend" src="<%=basePath%>baobaohui/js/require-min-2.2.js"></script>
	</body>
