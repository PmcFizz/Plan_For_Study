	...
	<body basepath="<%=basePath%>">
		...
		<div class="search" id="search">
			<div class="selectC_box clearfix">
				...
				<ul>
					<li class="all active"><a data-href="<%=basePath %>order/toallsale.do" class="check ordertab">所有</a></li>
		...
		<script type="text/javascript" data-main="<%=basePath%>baobaohui/js/sale/mysale-all" src="<%=basePath%>baobaohui/js/require-min-2.2.js"></script>
	</body>
</html>